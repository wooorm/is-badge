...
test('isBadge(url)', function (t) {
    ...
    t.test('shields.io', function (st) {
        ...
        st.equal(
            isBadge(
                'https://img.shields.io/teamcity/http/' +
                'teamcity.jetbrains.com/s/bt345.svg'
            ),
            true,
            'ok: extensive'
        );
    ...
    t.test('david-dm', function (st) {
        ...
        st.equal(
            isBadge(
                'https://david-dm.org/strongloop/express.svg?' +
                'style=flat-square'
            ),
            true,
            'ok: flat-square'
    ...
    t.test('testling-ci', function (st) {
        ...
        st.equal(
            isBadge(
                'https://ci.testling.com/_/images/' +
                'testling_mission_control.png'
            ),
            false,
            'not ok: w/o project'
        );
    ...
    t.test('coveralls', function (st) {
        ...
        st.equal(
            isBadge(
                'https://coveralls.io/assets/' +
                'home_bitbucket-9172913f63c2492acfd0b67d9f0ad404.png'
            ),
            false,
            'not ok: w/o project'
        );
